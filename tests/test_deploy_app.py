...
class VerticalServicesContractTests(unittest.TestCase):
    ...
    def test_root_and_control_plane(self):
        ...
        self.assertIn("<strong>REACHABLE</strong> Python runtime contract", root.text)
        self.assertNotIn("<strong>LIVE</strong> Python runtime contract", root.text)
        self.assertNotIn("<strong>ALLOW</strong>", root.text)
        self.assertNotIn("<strong>MEASURED</strong>", root.text)
